 ...
 * @author Etsh
 */
public class stu_pro1 extends javax.swing.JFrame {
    ...
    try {
       ...
       String g = " select id_pro,date_pro,first_sides,second_side,supervi,first_notes,second_notes,sup_notes  from pro2 ";
    ...
    private void initComponents() {
        ...
        super_notes.setFont(new java.awt.Font("Motken daeira", 1, 18)); // NOI18N
        ...
        first_notes.setFont(new java.awt.Font("Motken daeira", 1, 18)); // NOI18N
        ...
        second_notes.setFont(new java.awt.Font("Motken daeira", 1, 18)); // NOI18N
 ...
 Connection con = Connect.connect();
     ...
     try{
        ...
        String sql=" insert into pro1 (first_sides,second_side  ,supervi,first_notes,second_notes,date_pro,sup_notes)values( '"+first_side.getText()+"','"+second_side.getText()+"','"+supervi.getSelectedItem()+"','"+first_notes.getText()+"','"+second_notes.getText()+"','"+date_pro.getText()+"','"+super_notes.getText()+"' )";
   ...
   if(Search.getSelectedItem().equals("ID" ))
      {
          try {
              ...
              String g = "select  id_pro,date_pro,first_sides,second_side,supervi,first_notes,second_notes,sup_notes from pro2 where id_pro='"+ser.getText()+"' " ;
      ...
      }else if (Search.getSelectedItem().equals("Name"))
      {
       try {
              ...
              String g1 = "select id_pro,date_pro,first_sides,second_side,supervi,first_notes,second_notes,sup_notes from pro2 where first_sides ='"+ser.getText()+"'|| second_side ='"+ser.getText()+"' " ;
      ...
      }else if (Search.getSelectedItem().equals("Supervisor"))
      {
       try {
               ...
               String g12 = "select id_pro,date_pro,first_sides,second_side,supervi,first_notes,second_notes,sup_notes from pro2 where supervi='"+ser.getText()+"' " ;
  ...
  con =Connect.connect();
     ...
     String sql=" update pro2 set first_sides='"+first_side.getText()+"',second_side='"+second_side.getText()+"',supervi='"+supervi.getSelectedItem()+"',first_notes='"+first_notes.getText()+"',second_notes='"+second_notes.getText()+"',sup_notes='"+super_notes.getText()+"' where 	id_pro='"+id_pro.getText()+"'";
 ...
 int r=jTable1.getSelectedRow();
        ...
        try{
            ...
            String sql1 ="Select * from pro2 where id_pro = '"+n +"'";
            ...
            if(rs.next())
            {
                ...
                String x1 = rs.getString("first_sides");
                ...
                String x6 = rs.getString("sup_notes");
